...
(function() {
  ...
  Madeleine = function(options) {
    ...
    Madeleine.prototype.init = function() {
      ...
      this.__camera.position.set(0, -180, 0);
    ...
    Madeleine.prototype.adaptViewerTheme = function() {
      ...
      switch (theme) {
        ...
        case "cobalt":
          ...
          break;
        case "light":
          this.__viewer.style.cssText += this.generateGradation({bright: "e6ffe6"});
          this.options.objectColor = "0080C6";
          break;
        case "soft":
    ...
    Madeleine.prototype.startAnimation = function() {
      if (this.__rotatable) this.__rotating = false;
      this.interact(this);
    };
